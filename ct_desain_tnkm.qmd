---
title: "Kamera Intai"
subtitle: "Teknik Pemasangan dan Pengamatan Satwa"
...
in_maxent  <- Sp_occs %>%
  ...
  mutate(species = ifelse(species == 1, 'Neofelis.diardi', #ganti nama ini untuk spesies lain
                          NA)) %>%
  na.omit()
...
Karena membutuhkan dataset yang agak banyak, kita akan 
```{r act_table, echo=TRUE, results='hide', fig.show='hide'}
